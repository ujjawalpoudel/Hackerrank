"""
You are given an unsorted list of integers. I
mplement the Insertion Sort algorithm to sort the list in ascending order.

Insertion Sort works by iterating through the list and picking each element one by one. 
It compares the current element with the previous elements and places it in the correct position in the sorted part of the list. 
